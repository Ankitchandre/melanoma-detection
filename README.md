...
As the model's accuracy improves, its loss decreases. The final model achieves an accuracy of 87% with a loss of 0.3, demonstrating its ability to predict lesion classes with high accuracy. Data augmentation and addressing class imbalance were key factors in enhancing the model's performance.
